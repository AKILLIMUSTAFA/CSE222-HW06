 ...
 */
public class LinkedListPriorityQueue<E> implements PriorityQueueInterface<E>{
     ...
     */
    public LinkedListPriorityQueue(Comparator<E> newComparator){
        setTheData();
     ...
     * @return The Data
     */
    private LinkedList<E> getTheData() {
        return theData;
    }
     ...
     * pre The LinkedList theData is in heap order.
    ...
    public E dequeue() {
        ...
        // Save the top of the LinkedList.
        ...
        // Remove the last item from the LinkedList and place it into
        // the first position.
